...
class A_GPR:
    ...
    def creat_gp_model(self, max_loop=15, x_init_l=None, y_init_l=None, n_start = 1, n_single=200, x_conda=None, y_conda=None, init_num=None):
        '''
        ...
        '''
        # 初始化模型
        x_init_h, y_init_h = self.sample_point(x_data_conda=x_conda, y_data_conda=y_conda, iter=init_num, is_init=True)
        ...
        return hf_gp, list_w_hf, x_init_h, y_init_h