...
# x_train_l, y_train_l = a_gpr.sample_point(x_train, y_train, iter=50)
...
for i in range(1):
    ...
    list_mse_gpr.append(mean_squared_error(y_test, y_pre_con))
    list_mse_lgb.append(mean_squared_error(y_test, y_pre_lgb))
    list_mse_svr.append(mean_squared_error(y_test, y_pre_svr))


print(np.mean(list_mse_gpr))
print(np.mean(list_mse_lgb))
print(np.mean(list_mse_svr))
